...
export async function GET() {
  ...
  const css = `
    ...
    .controls{display:flex;gap:.75rem;margin-bottom:1.25rem;align-items:center;flex-wrap:wrap}
    .view-toggle{display:flex;border:1px solid #ffb4dd}
    .view-toggle button{padding:.4rem .9rem;background:transparent;color:#ffb4dd;border:0;cursor:pointer;font-size:.85rem;text-transform:lowercase}
    .view-toggle button.active{background:#ffb4dd;color:#0a0a0a}
    .search-input{padding:.4rem .7rem;background:transparent;border:1px solid #ffb4dd;color:#ffb4dd;font-size:.85rem;width:200px}
    .search-input::placeholder{color:#6e4a5e}
    .count{font-size:.8rem;color:#6e4a5e}
    #grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1rem}
    #grid.list{display:flex;flex-direction:column;gap:.5rem}
    ...
    .images:hover{opacity:.85}
    .card img{width:100%;height:200px;object-fit:cover;display:block}
    #grid.list .card img{height:100px}
    .noimg{height:200px;display:flex;align-items:center;justify-content:center;background:#1a1a1a;font-size:.8rem;color:#6e4a5e}
    #grid.list .noimg{width:120px;height:100px;flex-shrink:0}
    .meta{padding:.85rem;display:flex;flex-direction:column;gap:.3rem;flex:1}
    .meta p{font-size:.85rem;margin:0}
    .meta time{font-size:.72rem;color:#6e4a5e}
    .story{white-space:pre-wrap;margin-top:.3rem}
    .lightbox{display:none;position:fixed;inset:0;background:rgba(0,0,0,.92);align-items:center;justify-content:center;z-index:1000;cursor:pointer}
    ...
    .lb-nav{display:flex;justify-content:center;gap:.4rem;margin-top:.5rem}
